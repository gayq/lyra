...
export class FolioHeaders {
	...
	static fromRawHeaders(raw: RawHeaders): FolioHeaders {
		const h = new FolioHeaders();
	...
	static fromNativeHeaders(native: Headers): FolioHeaders {
		const h = new FolioHeaders();
